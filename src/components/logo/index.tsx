      ...
      <span className={className}>
        {icon ? (
          ...
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M487.4,0h-20.4V3.6h20.4V24h3.6V0h-3.6Z" fill="currentColor"/>
            <path d="M24,0H0V24H3.6V3.6H24V0Z" fill="currentColor"/>
            <path d="M0,139.4v3.6H24v-3.6H3.6v-20.4H0v20.4Z" fill="currentColor"/>
            <path d="M491,139.4v-20.4h-3.6v20.4h-20.4v3.6h24v-3.6Z" fill="currentColor"/>
            <g>
              <path d="M66.8,107.5c-10.2,0-18.8-3.4-25.8-10.1s-10.5-15.6-10.5-26.6,3.5-20,10.6-26.8c7.1-7,15.4-10.4,24.9-10.4s17,2.3,22.5,6.9c5.5,4.6,9,10.2,10.6,16.7l-13,4.1c-1-4.1-3.1-7.5-6.3-10.2-3.2-2.7-7.6-4.1-13.4-4.1s-10.8,2.1-15.1,6.2c-4.4,4.2-6.5,9.9-6.5,17.3s2.1,13.2,6.4,17.4,9.3,6.3,15.1,6.3,10.4-1.4,13.7-4.3c3.3-2.9,5.5-6.3,6.6-10.2l12.9,3.9c-1.6,6.1-4.9,11.4-9.9,16-2.6,2.4-5.9,4.3-9.9,5.8-3.9,1.4-8.2,2.1-12.9,2.1Z" fill="currentColor"/>
              <path d="M120.4,106h-13.3V33.6h13.3V106Z" fill="currentColor"/>
              <path d="M139.2,32.4c2.3,0,4.2,.8,5.8,2.4,1.6,1.6,2.3,3.5,2.3,5.8s-.8,4.2-2.3,5.8c-1.6,1.6-3.6,2.3-5.9,2.3s-4.2-.8-5.8-2.3c-1.6-1.6-2.4-3.5-2.4-5.8s.8-4.2,2.4-5.8c1.7-1.6,3.6-2.4,5.9-2.4Zm6.7,73.6h-13.3V56.8h13.3v49.2Z" fill="currentColor"/>
              <path d="M171.4,125h-13.4V56.8h13v6c1.2-2,3.1-3.7,5.8-5,2.7-1.4,5.8-2.1,9.3-2.1,7.1,0,12.6,2.4,16.7,7.1,4.1,4.8,6.2,10.9,6.2,18.5s-2.2,13.8-6.5,18.6c-4.4,4.9-9.9,7.3-16.6,7.3s-11.5-2-14.5-6v23.8Zm20.8-33.5c2.3-2.5,3.4-5.9,3.4-10.2s-1.1-7.6-3.4-10.1c-2.3-2.4-5.2-3.7-8.7-3.7s-6.5,1.2-8.8,3.7-3.5,5.8-3.5,10.1,1.2,7.6,3.5,10.1,5.3,3.8,8.8,3.8c3.5,.1,6.4-1.2,8.7-3.7Z" fill="currentColor"/>
